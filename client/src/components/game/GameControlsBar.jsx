...
import { Box, TextField, Button, Slider, Checkbox, FormControlLabel } from "@mui/material";
    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: "flex", gap: 2, alignItems: "center", flexWrap: "wrap" }}>
                {/* Voice selector */}
                <select
                    value={voiceOptions.find((option) => option.value === voiceOption)?.label || ""}
                ...
                <Box sx={{ display: "flex", gap: 1, alignItems: "center" }}>
                    <FormControlLabel
                        ...
                        label={<span style={{ color: "#9ca3af", fontSize: "0.75rem" }}>Manual</span>}
                    />
                    <FormControlLabel
                        control={
                            <Checkbox
                                checked={isAutomatic || true}
                                onChange={(e) => setIsAutomatic && setIsAutomatic(e.target.checked)}
                                sx={{ color: "#9ca3af", "&.Mui-checked": { color: "#60a5fa" } }}
                                size="small"
                            />
                        }
                        label={<span style={{ color: "#9ca3af", fontSize: "0.75rem" }}>Automatic</span>}
                    />
                </Box>
            </Box>

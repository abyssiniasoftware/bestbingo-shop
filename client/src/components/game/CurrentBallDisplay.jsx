...
const CurrentBallDisplay = ({ currentNumber, size = "large" }) => {
    ...
    const sizeStyles = {
        large: {
            container: { width: { xs: 100, sm: 130, md: 150 }, height: { xs: 100, sm: 130, md: 150 } },
            number: { fontSize: { xs: "2.5rem", sm: "3.5rem", md: "4rem" } },
        },
        medium: {
            container: { width: { xs: 80, sm: 100, md: 120 }, height: { xs: 80, sm: 100, md: 120 } },
            number: { fontSize: { xs: "2rem", sm: "2.5rem", md: "3rem" } },
        },
        small: {
            container: { width: { xs: 60, sm: 70, md: 80 }, height: { xs: 60, sm: 70, md: 80 } },
    ...
    return (
        <Box
            ...
            sx={{
                ...
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 0 30px rgba(255, 165, 0, 0.6), 0 10px 30px rgba(0, 0, 0, 0.3)",
